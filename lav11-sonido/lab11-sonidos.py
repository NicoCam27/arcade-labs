...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.gun_sound = arcade.sound.load_sound("a.wav")
        self.hit_sound = arcade.sound.load_sound("uwu.wav")
...
#P.S. look at the bullet angle maybe for other uses such as bullets changing orientation when the player changes orientation.